...
const listenForDevMode = () => {
    document.addEventListener('keydown', event => {
        ...
        // Position CPU hands in different locations
        cpuHandDom.style.top = '20px'      // Original CPU at top
        cpuHandDom.style.left = '50%'
        cpuHandDom.style.transform = 'translateX(-50%)'
        
        cpu2HandDom.style.left = '20px'    // CPU2 on left side
        cpu2HandDom.style.top = '50%'
        cpu2HandDom.style.transform = 'translateY(-50%) rotate(90deg)'
        
        const cpu2ScoreDom = document.querySelector('#cpu2-score')
        const cpu2Uno = document.querySelector('.cpu2-animation')
        let cpu2Score = 0

        // Position score display
        cpu2ScoreDom.style.left = '40px'
        cpu2ScoreDom.style.top = '20%'
